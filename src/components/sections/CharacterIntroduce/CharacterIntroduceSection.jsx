      ...
      <div className="container mx-auto px-4 max-w-7xl mb-12">
        ...
        <div className="relative w-full max-w-4xl mx-auto mb-8">
          ...
          <div className="overflow-hidden px-12 p-12">
            ...
            >
              {/* Render 5 positions: 2 trái, 1 giữa (active), 2 phải */}
              {Array.from({ length: 5 }, (_, i) => {
                // Tính toán index thực tế cho mỗi vị trí
                let actualIndex;
                if (i === 0) {
                  // Far left
                  actualIndex =
                ...
                const isActive = i === 2; // Giữa luôn là active
                const distance = Math.abs(i - 2); // Distance từ center
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {/* Character image - sử dụng image đầu tiên từ mảng images */}
                        ...
                        {/* Sliding overlay effect during transition */}
                        {isTransitioning && (
              ...
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 ${
                  index === currentCharacterIndex
                    ? `${currentCharacter.textColor.replace(
                        "text-",
                        "bg-"
                      )} scale-125`
